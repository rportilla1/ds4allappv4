...
SQL_Query = pd.read_sql(
        '''
        SELECT idruta, idvehiculo, secuenciarecorrido, recorridoincumplido, cantidadregistros, fecharegistro, distanciarecorrido, pasajerossuben, pasajerosbajan, longitud, latitud, velocidad  
...
intro = html.Div(
                        [
                            html.Div(
                                [
                                    html.H5("INTRODUCCIÓN", style=CONTENT_STYLE
                                        ),
...
content_second_row = dbc.Row(dbc.Col(intro,md=10))
